data = read.table("1.raw_data/raw_counts.txt",header = T,row.names = 1)
data = as.data.frame(data)
mirna = data[1:9136,c(21:25,31:35)]
mirna = mirna[which(rowSums(mirna) > 0),]
...
dir.create("3.WGCNA/15.module_hub_genes")
setwd("3.WGCNA/15.module_hub_genes")
